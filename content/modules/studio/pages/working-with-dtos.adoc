...
In order to do this, use the *_JPA Entity from POJO_* option available both in the "+" menu in the Amplicode tool window and in the Context menu in the project tree.
